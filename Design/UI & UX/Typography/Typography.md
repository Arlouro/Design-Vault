...
Baseline Grid
- Search definition!! (Grid that uses the baseline to have the text organized by lines)

Letras curvas como por exemplo a letra "O" devem passar a baseline de forma a que pareçam do mesmo tamanho que as restantes letras.


# Size

Na tipografia tradicional utilizava-se a medida "picas"
